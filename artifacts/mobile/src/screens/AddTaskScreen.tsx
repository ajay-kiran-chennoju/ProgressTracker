 ...
 * AddTaskScreen.tsx
 *
 * Mirrors AddEntryScreen structure. Allows users to create a pending task
 * for a given category. Includes suggestions and duplicate prevention.
 */
...
export default function AddTaskScreen() {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      // Optimistic: pass new task back to caller
